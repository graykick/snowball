...
class Player extends Object {
    ...
    throwBall(pointX, pointY) {
        var newBall = new Ball(this.location.x, this.location.y, this.throwPower, new Vector(pointX, pointY), this.id);
    ...
    getInitPack() {
        return {
            ...
            vLocationX: this.vLocation.x,
            vLocationY: this.vLocation.y,
