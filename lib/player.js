...
class Player extends Object {
  ...
  vLocationUpdate() {
    ...
    checkOtherPlayer(player){
      if(this.velocity.y >= 0 && (this.location.y + this.mass*2 < player.location.y+player.mass*2 && this.location.y + this.mass*2 > player.location.y)
       && (this.location.x + this.mass > player.location.x && this.location.x + this.mass < player.location.x+player.mass*2)
       && this.location.y+this.mass*2 > player.location.y){
    ...
    throwBall(pointX, pointY) {
        var newBall = new Ball(this.location.x, this.location.y, this.throwPower, this.throwDemage, this.ballHp, new Vector(pointX, pointY), this.id, this.socketId, this.team);
