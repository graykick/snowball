...
if (cluster.isMaster) {
    ...
    var app = express(),
        ...
        startFlag = true;
    var Atower = new Tower(3578, 3609); // Atower range 3578 ~ 3609
    var Btower = new Tower(3412, 3643); // B tower :  3612 ~ 3643
    ...
    */
    ...
    io.sockets.on('connection', (socket) => {
        ...
        // player객체를 매개변수로 받으면 object로 리턴
